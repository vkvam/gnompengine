...
public class AWTTextureFactory extends ShapeTextureFactory {
    ...
    public static class DesktopShapeTexture extends Texture implements ShapeTexture {
        ...
        public void draw(StructureNode structure){
            ...
            Shape jShape = createAWTShape(structure);

            drawFilled(structure,jShape);
            drawLine(structure, jShape);
        }

        private void drawFilled(StructureNode structure, Shape shape){
        ...
        private void drawLine(StructureNode structure, Shape shape){
        ...
        private java.awt.Shape createAWTShape(StructureNode structure) {
            ...
            float angle = structure.worldTranslation.angle;
        ...
        private java.awt.Shape circleToShape(Circle circle, Vector2 offsetPosition) {
