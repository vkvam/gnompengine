 ...
 * @author stbachmann
 * @author Nathan Sweet */
public class GL2ShapeRenderer implements Disposable {
    ...
    public GL2ShapeRenderer () {
        this(5000);
    }

    public GL2ShapeRenderer (int maxVertices) {
        this(maxVertices, null);
    }

    public GL2ShapeRenderer (int maxVertices, ShaderProgram defaultShader) {
